...
import com.example.myapplication.database.updatePhonesToDatabase
...
fun initContacts() {
    if (checkPermissions(READ_CONTACTS)) {
        ...
        cursor?.let {
            while (it.moveToNext()) {
                val fullName =
                    it.getStringOrNull(it.getColumnIndex(ContactsContract.Contacts.DISPLAY_NAME))
                val phone =
                    it.getStringOrNull(it.getColumnIndex(ContactsContract.CommonDataKinds.Phone.NUMBER))
